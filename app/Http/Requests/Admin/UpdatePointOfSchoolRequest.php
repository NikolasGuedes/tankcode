...
class UpdatePointOfSchoolRequest extends FormRequest
{
    ...
    {
        /** @var PointOfSchool $pointOfSchool */
        $pointOfSchool = $this->route('point_of_school') ?? $this->route('pointOfSchool');

        return [
            'school_id' => ['required', 'integer', Rule::exists('schools', 'id')],
            'name' => ['required', 'string', 'max:255'],
            'cnpj' => ['required', 'digits:14', new ValidCnpj, new UniqueCnpjAcrossEntities('point_of_schools', $pointOfSchool?->id)],
