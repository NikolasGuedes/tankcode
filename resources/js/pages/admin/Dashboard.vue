...
const modules = [
    ...
    { title: 'Usuários', description: 'Gerencie perfis, papéis e acessos globais.', href: '/admin/users', icon: Users },
];
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <section class="space-y-6 p-6">
            <AppReveal class-name="rounded-[2rem] border border-border bg-card p-8 shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
                <h1 class="text-4xl font-semibold tracking-tight text-white">Administração</h1>
                <p class="mt-2 text-lg text-white/70">Gerencie escolas, pontos de ensino e usuários da plataforma.</p>
