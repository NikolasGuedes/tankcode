...
const isStep2Valid = () => {
  ...
  return activityForm.value.questions.every((question) => {
    ...
    const allOptionsHaveText = ['A', 'B', 'C', 'D'].every(
      (option) => question.options[option as OptionKey]?.trim() !== ''
    )
                ...
                <div class="grid grid-cols-3 gap-3">
                  <button
                    ...
                    :class="activityForm.difficulty === level
                      ...
                      : getDifficultyClass(level as Difficulty)"
                    @click="activityForm.difficulty = level as Difficulty"
                  >
                    {{ level }}
                  </button>
                </div>
                  ...
                  >
                    <div class="flex items-start gap-3">
                      <button
                        ...
                        @click="setCorrectOption(option as OptionKey)"
                      >
                      ...
                      <div class="flex-1">
                        ...
                        <input
                          v-model="currentQuestion.options[option as OptionKey]"
                          class="w-full rounded-xl border border-white/10 bg-black/30 px-4 py-3 text-sm outline-none focus:border-[#5b4dff]"
                ...
                <div class="mt-5 rounded-2xl border border-white/10 bg-black/20 p-4">
                  ...
                  <div class="mt-4 space-y-3">
                    ...
                    >
                      {{ option }}.
                      {{
                        activityForm.questions[previewQuestion]?.options[option as OptionKey] ||
                        `Alternativa ${option}`
                      }}
                    </div>
                  </div>
