...
/**
* @see \App\Http\Controllers\Owner\DirectorController::updateAccess
* @see app/Http/Controllers/Owner/DirectorController.php:165
* @route '/owner/directors/{director}/access'
*/
export const updateAccess = (args: { director: string | number | { id: string | number } } | [director: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
...
* @route '/owner/directors/{director}/access'
*/
updateAccess.url = (args: { director: string | number | { id: string | number } } | [director: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { director: args }
    }
...
* @route '/owner/directors/{director}/access'
*/
updateAccess.patch = (args: { director: string | number | { id: string | number } } | [director: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updateAccess.url(args, options),
    method: 'patch',
})
...
* @route '/owner/directors/{director}/access'
*/
const updateAccessForm = (args: { director: string | number | { id: string | number } } | [director: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/owner/directors/{director}/access'
*/
updateAccessForm.patch = (args: { director: string | number | { id: string | number } } | [director: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: updateAccess.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PATCH',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const DirectorController = { index, create, edit, store, update, updateAccess, resendInvitation, destroy }
